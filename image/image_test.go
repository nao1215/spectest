...
func TestEqualFromFileWithThreshold(t *testing.T) {
	t.Parallel()
	t.Run("should return nil if images are equal. Threshold is 0.1", func(t *testing.T) {
		t.Parallel()
		...
		fn := EqualFromFileWithThreshold(expected, 0.1)
		err = fn(response, request)
		if err != nil {
			t.Errorf("EqualFromFile() error = %v, wantErr %v", err, nil)
		}
	...
	t.Run("should return nil if images are equal. Threshold is 0.9", func(t *testing.T) {
		t.Parallel()
		...
		fn := EqualFromFileWithThreshold(expected, 0.9)
		err = fn(response, request)
		if err != nil {
			t.Errorf("EqualFromFile() error = %v, wantErr %v", err, nil)
		}
	...
	t.Run("should return error if images are not equal", func(t *testing.T) {
		...
		fn := EqualFromFileWithThreshold(expected, 0.3)
		err = fn(response, request)
		if err == nil {
			t.Errorf("EqualFromFile() does not return error")
		}
	...
	t.Run("should return nil if images are not equal, threshold is 0.9", func(t *testing.T) {
		t.Parallel()
